...
trade_data={
    ...
    "PE_LTP":None,"CE_LTP":None,"limit_PE":None,"limit_CE":None,'trigger_PE':None,'trigger_CE':None,"PE_ATM_sell_status":False,"CE_ATM_sell_status":False
}

buy_data={}

def buy_sl_order(buy_id,LTP,cur_price,tradingSym_ATM,limit,sl_reached,trigger,quantity,symbol_T):
    ...
    if(buy_id==None): 
        ...
        if(not_triggered==False): 
            sl_reached=True
            if(symbol_T=="PE"): trade_data['PE_ATM_sell_status']=False
            else: trade_data['CE_ATM_sell_status']=False
  ...
  for tick in ticks:
      ...
      if(is_current_time(trade_data['exit_hr'],trade_data['exit_min'])):
          if(trade_data['PE_OTM_buy_order'] and trade_data['PE_OTM_sell_status']==False): 
              trade_data['PE_OTM_sell_status']=True
              ...
              if(PE_OTM_sell_order==None): trade_data['PE_OTM_sell_status']=False

          if(trade_data['CE_OTM_buy_order'] and trade_data['CE_OTM_sell_status']==False): 
              trade_data['CE_OTM_sell_status']=True
              ...
              if(CE_OTM_sell_order==None): trade_data['CE_OTM_sell_status']=False
          time.sleep(2)
          continue
      ...
      if(trade_data['sl_reached_PE'] and trade_data['sl_reached_CE']):
        ...
        #   if(quantity==0 or (quantity>(num_lot*lot_size))): quantity=num_lot*lot_size
          ...
          if(trade_data['PE_OTM_buy_order']==None): 
              trade_data['PE_OTM_buy_order']=True
          ...
          if(trade_data['CE_OTM_buy_order']==None): 
              trade_data['CE_OTM_buy_order']=True
          ...
          if(trade_data['PE_OTM_buy_order'] and trade_data['CE_OTM_buy_order']):
              if(trade_data['PE_ATM_sell_status']==False): 
                  trade_data['PE_ATM_sell_status']=True
                  ...
                  if(PE_ATM_sell_order): buy_data[trade_data['tradingSym_PE_ATM']]=0
                  else: trade_data['PE_ATM_sell_status']=False
             
              if(trade_data['CE_ATM_sell_status']==False):
                  trade_data['CE_ATM_sell_status']=True
                  ...
                  if(CE_ATM_sell_order): buy_data[trade_data['tradingSym_CE_ATM']]=0 
                  else: trade_data['CE_ATM_sell_status']=False
              
              if(trade_data['PE_ATM_sell_status'] and trade_data['CE_ATM_sell_status']):
      ...
      if(tick['instrument_token']!=token_PE and tick['instrument_token']!=token_CE): 
          ...
          if(trade_data['PE_buy_id']==None):
            if buy_data[trade_data['tradingSym_PE_ATM']]: continue
            else: buy_data[trade_data['tradingSym_PE_ATM']]+=1
          ...
          trade_data['PE_buy_id'],trade_data['PE_LTP'],trade_data['limit_PE'],trade_data['trigger_PE'],trade_data['sl_reached_PE']=buy_sl_order(trade_data['PE_buy_id'],trade_data['PE_LTP'],cur_PE_price,trade_data['tradingSym_PE_ATM'],trade_data['limit_PE'],
                                                                       trade_data['sl_reached_PE'],trade_data['trigger_PE'],quantity,"PE")
          ...
          if(trade_data['CE_buy_id']==None):
              if(buy_data[trade_data['tradingSym_CE_ATM']]): continue
              else: buy_data[trade_data['tradingSym_CE_ATM']]+=1
          ...
          trade_data['CE_buy_id'],trade_data['CE_LTP'],trade_data['limit_CE'],trade_data['trigger_CE'],trade_data['sl_reached_CE']=buy_sl_order(trade_data['CE_buy_id'],trade_data['CE_LTP'],cur_CE_price,trade_data['tradingSym_CE_ATM'],trade_data['limit_CE']
                                                                       ,trade_data['sl_reached_CE'],trade_data['trigger_CE'],quantity,"CE")
