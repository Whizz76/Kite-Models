...
access_token = "LATetnTDFInlIzkfAQvLyJmhSMT4yFHt"
...
def on_ticks(ws, ticks):
  ...
  for tick in ticks:
      ...
      if(trade_data['sl_reached_PE'] and trade_data['sl_reached_CE']):
          ...
          tradingSym_PE_ATM=trade_data['symbol']+str(trade_data['SP'])+"PE"
          tradingSym_CE_ATM=trade_data['symbol']+str(trade_data['SP'])+"CE"
          print(tradingSym_CE_ATM,tradingSym_PE_ATM)
      ...
      if(tick['instrument_token']==token_PE): 
          ...
          print("PE_LTP {} limit_PE {} trigger_PE {} sl_reached_PE {}".format(PE_LTP,limit_PE,trigger_PE,trade_data['sl_reached_PE']))

      if(tick['instrument_token']==token_CE): 
          cur_CE_price=tick['last_price']
          print("CE cur price ",cur_CE_price)
          ...
          print("CE_LTP {} limit_CE {} trigger_CE {} sl_reached_CE {}".format(CE_LTP,limit_CE,trigger_CE,trade_data['sl_reached_CE']))
