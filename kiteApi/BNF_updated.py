...
def place_order_time(time_hour,time_minute):
    ...
    if(placeOrder):
        ...
        time.sleep(1)
        if(PE_1500): PE_1500_LTP=kite.quote("NFO:"+tradingSym_PE_1500)["NFO:"+tradingSym_PE_1500]['last_price']

        CE_1500=place_order(tradingSym_CE_1500,"buy",kite.EXCHANGE_NFO,kite.ORDER_TYPE_MARKET,kite.PRODUCT_MIS)
        time.sleep(1)
        if(CE_1500): CE_1500_LTP=kite.quote("NFO:"+tradingSym_CE_1500)["NFO:"+tradingSym_CE_1500]['last_price']
        ...
        PE_stoploss_orderid_1500=None
        CE_stoploss_orderid_1500=None
        ...
        while True:
            ...
            cur_CE_price_1500=kite.quote("NFO:"+tradingSym_CE_1500)["NFO:"+tradingSym_CE_1500]['last_price']
            cur_PE_price_1500=kite.quote("NFO:"+tradingSym_PE_1500)["NFO:"+tradingSym_PE_1500]['last_price']

            if(PE_stoploss_orderid!=None and CE_stoploss_orderid!=None and PE_stoploss_orderid_1500!=None and CE_stoploss_orderid_1500!=None):
                break
                ...
                if(PE_stoploss_orderid_1500==None): PE_stoploss_orderid_1500=place_order(tradingSym_PE_1500,"sell",kite.EXCHANGE_NFO,kite.ORDER_TYPE_MARKET,kite.PRODUCT_MIS)
                if(CE_stoploss_orderid_1500==None): CE_stoploss_orderid_1500=place_order(tradingSym_CE_1500,"sell",kite.EXCHANGE_NFO,kite.ORDER_TYPE_MARKET,kite.PRODUCT_MIS)

                break

            else:
                limit_buy=1+stoploss
                limit_sell=1-stoploss
                
                if (PE_stoploss_orderid==None and PE_LTP!=None and cur_PE_price>=(PE_LTP*limit_buy)):
                    PE_stoploss_orderid=place_order(tradingSym_PE,"buy",kite.EXCHANGE_NFO,kite.ORDER_TYPE_MARKET,kite.PRODUCT_MIS)

                if (CE_stoploss_orderid==None and CE_LTP!=None and cur_CE_price>=(CE_LTP*limit_buy)):
                    CE_stoploss_orderid=place_order(tradingSym_CE,"buy",kite.EXCHANGE_NFO,kite.ORDER_TYPE_MARKET,kite.PRODUCT_MIS)
                
                if(PE_stoploss_orderid_1500==None and PE_1500_LTP!=None and cur_PE_price_1500<=(PE_1500_LTP*limit_sell)):
                    PE_stoploss_orderid_1500=place_order(tradingSym_PE_1500,"sell",kite.EXCHANGE_NFO,kite.ORDER_TYPE_MARKET,kite.PRODUCT_MIS)

                if(CE_stoploss_orderid_1500==None and CE_1500_LTP!=None and cur_CE_price_1500<=(CE_1500_LTP*limit_sell)):
                    CE_stoploss_orderid_1500=place_order(tradingSym_CE_1500,"sell",kite.EXCHANGE_NFO,kite.ORDER_TYPE_MARKET,kite.PRODUCT_MIS)
